...
public class LoginActivity extends AppCompatActivity {
    ...
    public void callLogin(View view){
        ...
        if(email.isEmpty() || password.isEmpty()){
            Toast.makeText(this, "Tiene que completar los campos.", Toast.LENGTH_SHORT).show();
            return;
        }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(LoginActivity.this, "Fallo el registro.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    private void initGoogleSignIn(){
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("938290150962-mi8ntm4put62auriabqnnl1d2gv7a19i.apps.googleusercontent.com")
                .requestEmail()
                .build();
